...
class RSNN_i3(nn.Module):
    def __init__(self):
        ...
        beta_arr = torch.cat((beta_e, beta_iPV, beta_iSST, beta_iHtr)) # create array of betas corresponding to each neuron!
        ...
        # CHANGE TO RLEAKY??? PRESERVE REFRACTORY PERIOD
        ...
        self.rlif1 = RLIF1(reset_mechanism="zero",threshold=-55.0, beta=beta_arr, linear_features=num_hidden, all_to_all=True)
